	...
	})(
		{
				...
				function (e, t, r) {
					...
					(c.prototype.slice = function (e, t) {
						...
						(c.prototype.readUInt8 = function (e, t) {
							return (
								(e >>>= 0), t || E(e, 1, this.length), this[e]
							);
						}),
						...
						(c.prototype.readIntLE = function (e, t, r) {
							...
							for (
								...
								i += this[e + o] * n;
							return (
								(n *= 128) <= i && (i -= Math.pow(2, 8 * t)), i
							);
						}),
						(c.prototype.readIntBE = function (e, t, r) {
							(e >>>= 0), (t >>>= 0), r || E(e, t, this.length);
							for (
								var i = t, n = 1, o = this[e + --i];
								0 < i && (n *= 256);

							)
								o += this[e + --i] * n;
							return (
								(n *= 128) <= o && (o -= Math.pow(2, 8 * t)), o
							);
						}),
						...
						(e = this),
							(t = function () {
								...
								return (
									...
									(N.prototype._settledAt = function (
										e,
										t,
										r
									) {
									...
									(N.prototype._willSettleAt = function (
										e,
										t
									) {
										var r = this;
						...
						t.exports = function (o) {
							...
							return new Promise(function (t, e) {
								...
								n.setAttribute("src", "" + s + l + "=" + r),
									a.charset &&
										n.setAttribute("charset", a.charset),
									(n.id = i),
									document
										.getElementsByTagName("head")[0]
										.appendChild(n),
			...
			8: [
				function (e, t, r) {
					...
					function he(e, t) {
						for (
							var r = e.d, i = e.e, n = e.c, o = t, a = r[o];
							;
						...
						(e = this),
							(function (M) {
								...
								(C.prototype.isEmpty = function () {
									...
									(C.prototype.addBezier = function (
										e,
										t,
										r,
										i,
								...
								(oe.prototype.parseByte = function () {
									...
									(oe.prototype.parseCard8 =
										oe.prototype.parseByte),
									(oe.prototype.parseCard16 =
									...
									(oe.prototype.parseOffset32 =
										oe.prototype.parseULong =
											function () {
												var e = re(
													this.data,
													this.offset +
									...
									(oe.prototype.parseLongDateTime =
										function () {
											var e = re(
												this.data,
												this.offset +
									...
									(oe.prototype.skip = function (e, t) {
										void 0 === t && (t = 1),
											(this.relativeOffset += ne[e] * t);
									}),
									(oe.prototype.parseULongList = function (
										e
									) {
									...
									(oe.prototype.parseShortList = function (
										e
									) {
										for (
											var t = new Array(e),
									...
									(oe.prototype.parseList = function (e, t) {
										t ||
											((t = e), (e = this.parseUShort()));
										for (
											var r = new Array(e), i = 0;
											i < e;
											i++
										)
											r[i] = t.call(this);
									...
									(oe.prototype.parseList32 = function (
										e,
										t
									) {
									...
									(oe.prototype.parseRecordList = function (
										e,
										t
									) {
										t ||
									...
									(oe.prototype.parseRecordList32 = function (
										e,
										t
									) {
										t || ((t = e), (e = this.parseULong()));
									...
									(oe.prototype.parseValueRecord = function (
										e
									) {
										if (
											(void 0 === e &&
									...
									(oe.prototype.parseValueRecordList =
										function () {
											for (
									...
									(oe.prototype.parsePointer32 = function (
										e
									) {
									...
									(oe.prototype.parseListOfLists = function (
										e
									) {
										for (
											var t = this,
									...
									(oe.uShort = oe.offset16 =
										oe.prototype.parseUShort),
									(oe.uShortList =
										oe.prototype.parseUShortList),
									(oe.uLong = oe.offset32 =
										oe.prototype.parseULong),
									(oe.uLongList =
										oe.prototype.parseULongList),
								...
								(oe.prototype.parseScriptList = function () {
									...
									(oe.prototype.parseLookupList = function (
										i
									) {
										return (
											this.parsePointer(
									...
									(oe.prototype.parseFeatureVariationsList =
										function () {
											return (
												this.parsePointer32(
													function () {
								...
								var he = {
										parse: function (e, t) {
											...
											(r.version = se.getUShort(e, t)),
												...
												(r.numTables = se.getUShort(
													e,
													t + 2
												));
											for (
												var i = -1, n = r.numTables - 1;
												0 <= n;
												n -= 1
											) {
												var o = se.getUShort(
								...
								(de.prototype.charToGlyphIndex = function (e) {
									...
									(fe.prototype.charToGlyphIndex = function (
										e
									) {
										return (
									...
									(me.prototype.charToGlyphIndex = function (
										e
									) {
										var t = e.codePointAt(0),
											r = this.encoding[t];
									...
									(ve.prototype.nameToGlyphIndex = function (
										e
									) {
										return this.names.indexOf(e);
									}),
									(ve.prototype.glyphIndexToName = function (
										e
									) {
										return this.names[e];
									});
								...
								(ye.prototype.bindConstructorValues = function (
									e
								) {
									var t, r;
									...
									(ye.prototype.drawPoints = function (
										a,
										e,
										t,
										r
									...
									(ye.prototype.drawMetrics = function (
										e,
										t,
										r,
										i
								...
								function De(v, g, e) {
									...
									if (v.isCIDFont) {
										var r =
												v.tables.cff.topDict._fdSelect[
													g.index
												],
											i =
												v.tables.cff.topDict._fdArray[
													r
												];
										(w = i._subrs),
											(S = i._subrsBias),
									...
									parse: function (e, t, r) {
										...
										if (
											((r.tables.cff.topDict = u)
												._privateDict &&
												((r.defaultWidthX =
													u._privateDict.defaultWidthX),
												(r.nominalWidthX =
													u._privateDict.nominalWidthX)),
											void 0 !== u.ros[0] &&
												void 0 !== u.ros[1] &&
												(r.isCIDFont = !0),
											r.isCIDFont)
								...
								var Ve = {
									parse: function (e, t) {
										...
										return (
											...
											(r.advanceWidthMax =
												i.parseUShort()),
											(r.minLeftSideBearing =
												i.parseShort()),
											(r.minRightSideBearing =
												i.parseShort()),
										...
										parse: function (e, t) {
											...
											return (
												...
												1 === r.version &&
													...
													(r.maxFunctionDefs =
														i.parseUShort()),
													(r.maxInstructionDefs =
														i.parseUShort()),
													(r.maxStackElements =
														i.parseUShort()),
													(r.maxSizeOfInstructions =
														i.parseUShort()),
													(r.maxComponentElements =
														i.parseUShort()),
													(r.maxComponentDepth =
														i.parseUShort())),
												r
								...
								var ot = {
									parse: function (e, t) {
										...
										(r.version = i.parseUShort()),
											...
											(r.ySuperscriptYSize =
												i.parseShort()),
											(r.ySuperscriptXOffset =
												i.parseShort()),
											(r.ySuperscriptYOffset =
												i.parseShort()),
											(r.yStrikeoutSize = i.parseShort()),
											(r.yStrikeoutPosition =
												i.parseShort()),
								...
								function mt(e) {
									...
									(t.searchRange = 16 * r),
										...
										(t.rangeShift =
											16 * t.numTables - t.searchRange);
									for (
										var i = [],
											n = [],
											o =
												t.sizeOf() +
												ft().sizeOf() * t.numTables;
										o % 4 != 0;
									...
									return (
										i.sort(function (e, t) {
											return e.value.tag > t.value.tag
												? 1
												: -1;
										}),
								...
								var gt = {
									...
									fontToTable: function (e) {
										...
										(b.ascender = e.ascender),
											(b.descender = e.descender);
										var _ = Ne.make({
												flags: 3,
											...
											S = ot.make({
												...
												usWeightClass:
													e.tables.os2.usWeightClass,
												usWidthClass:
													e.tables.os2.usWidthClass,
												usFirstCharIndex: t,
												usLastCharIndex: l,
												ulUnicodeRange1: u,
												ulUnicodeRange2: c,
												...
												usDefaultChar: e.hasChar(" ")
													? 32
													: 0,
												usBreakChar: e.hasChar(" ")
													? 32
													: 0,
											}),
											T = ze.make(e.glyphs),
										...
										var I = [],
											...
											B =
												e.metas &&
												0 < Object.keys(e.metas).length
													? ct.make(e.metas)
													: void 0,
											F = [_, x, w, S, D, M, U, O, T];
										A && F.push(A),
											e.tables.gsub &&
												F.push(ut.make(e.tables.gsub)),
											B && F.push(B);
										for (
											var G = mt(F),
												N = dt(G.encode()),
								...
								((wt.prototype = xt.prototype =
									...
									this.defaultKerningTables =
										this.getKerningTables(e);
								}),
									(wt.prototype.getKerningValue = function (
										e,
										t,
										r
									) {
										for (var i = 0; i < e.length; i++)
											for (
												var n = e[i].subtables, o = 0;
												o < n.length;
												o++
											) {
												var a = n[o],
													s = this.getCoverageIndex(
														a.coverage,
														t
													);
												if (!(s < 0))
									...
									(wt.prototype.getKerningTables = function (
										e,
										t
									) {
									...
									((St.prototype =
										xt.prototype).createDefaultTable =
										function () {
											return {
												version: 1,
												scripts: [
									...
									(St.prototype.getSingle = function (
										e,
										t,
										r
									) {
										for (
											...
											for (
												var a = n[o].subtables, s = 0;
												s < a.length;
												s++
											) {
												var h = a[s],
													l = this.expandCoverage(
														h.coverage
													),
													u = void 0;
												if (1 === h.substFormat) {
									...
									(St.prototype.getAlternates = function (
										e,
										t,
										r
									) {
									...
									(St.prototype.getLigatures = function (
										e,
										t,
										r
									) {
									...
									(St.prototype.addSingle = function (
										e,
										t,
										r,
										i
									...
									(St.prototype.addAlternate = function (
										e,
										t,
										r,
										i
									...
									(St.prototype.addLigature = function (
										e,
										t,
										r,
										i
									) {
										var n = this.getLookupTables(
												r,
												i,
												e,
												4,
										...
										if (0 <= l) {
											for (
												var u = o.ligatureSets[l],
													c = 0;
												c < u.length;
												c++
											)
												if (Tt(u[c].components, s))
													return;
											u.push(h);
										} else
											(l = -1 - l),
												o.coverage.glyphs.splice(
													l,
													0,
													a
												),
												o.ligatureSets.splice(l, 0, [
													h,
												]);
									}),
									(St.prototype.getFeature = function (
										e,
										t,
										r
									) {
								...
								function Nt(e) {
									return (
										Math.sign(e) * Math.round(Math.abs(e))
									);
								}
								function Vt(e) {
									return (
										(Math.sign(e) *
											Math.round(Math.abs(2 * e))) /
										2
									);
								}
								function zt(e) {
									return (
										Math.sign(e) *
										(Math.round(Math.abs(e) + 0.5) - 0.5)
									);
								}
								function Ht(e) {
									return (
										Math.sign(e) * Math.ceil(Math.abs(e))
									);
								}
								function jt(e) {
									return (
								...
								Object.freeze(Xt),
									...
									(Yt.prototype.interpolate = function (
										e,
										t,
										r,
										i
									...
									(Yt.prototype.setRelative = function (
										e,
										t,
										r,
										i,
											...
											(this.zp0 =
												...
												(this.rp0 =
													...
													this.rp2 =
														0);
										case "prep":
											(this.fv = this.pv = this.dpv = Xt),
												(this.round = Nt);
									}
								}
								function er(e) {
									for (
										var t = (e.tZone = new Array(
												e.gZone.length
											)),
											r = 0;
										r < t.length;
								...
								function sr(e) {
									M.DEBUG && console.log(e.step, "POP[]"),
										e.stack.pop();
								}
								function hr(e, t) {
									var r = t.stack.pop(),
								...
								function mr(e, t) {
									var r = t.stack,
										...
										n = t.z2[i];
									M.DEBUG &&
										console.log(t.step, "GC[" + e + "]", i),
										r.push(
											64 * t.dpv.distance(n, Jt, e, !1)
										);
								}
								function vr(e, t) {
									var r = t.stack,
								...
								(Ft.prototype.exec = function (e, t) {
									...
									(Ot = function (e, t, r, i) {
										...
										for (var p = 0; p < h; p++)
											(n = l[p]),
												o || ((o = n), u.push(p)),
												n.lastPointOfContour
													? (((n.nextPointOnContour =
															o).prevPointOnContour =
															n),
													  (o = void 0))
													: ((a = l[p + 1]),
													  ((n.nextPointOnContour =
															a).prevPointOnContour =
															n));
										if (!t.inhibitGridFit) {
											if (M.DEBUG) {
												console.log(
									...
									(Dt = [
										...
										function (e) {
											M.DEBUG &&
												console.log(e.step, "RTG[]"),
												(e.round = Nt);
										},
										function (e) {
											M.DEBUG &&
												console.log(e.step, "RTHG[]"),
												(e.round = zt);
										},
										function (e) {
											var t = e.stack.pop();
											M.DEBUG &&
												console.log(e.step, "SMD[]", t),
												(e.minDis = t / 64);
										},
										function (e) {
											M.DEBUG &&
												console.log(e.step, "ELSE[]"),
												tr(e, !1);
										},
										function (e) {
											var t = e.stack.pop();
										...
										function (e) {
											var t = e.stack;
											M.DEBUG &&
												console.log(e.step, "DUP[]"),
												t.push(t[t.length - 1]);
										},
										sr,
										function (e) {
											M.DEBUG &&
												console.log(e.step, "CLEAR[]"),
												(e.stack.length = 0);
										},
										function (e) {
											var t = e.stack,
										...
										function (e) {
											M.DEBUG &&
												console.log(e.step, "MPPEM[]"),
												e.stack.push(e.ppem);
										},
										void 0,
										function (e) {
											M.DEBUG &&
												console.log(e.step, "FLIPON[]"),
												(e.autoFlip = !0);
										},
										void 0,
										void 0,
										...
										function (e) {
											var t = e.stack.pop();
											M.DEBUG &&
												console.log(e.step, "SDB[]", t),
												(e.deltaBase = t);
										},
										function (e) {
											var t = e.stack.pop();
											M.DEBUG &&
												console.log(e.step, "SDS[]", t),
												(e.deltaShift = Math.pow(
													0.5,
													t
												));
										},
										...
										function (e) {
											M.DEBUG &&
												console.log(e.step, "ROFF[]"),
												(e.round = Gt);
										},
										void 0,
										function (e) {
											M.DEBUG &&
												console.log(e.step, "RUTG[]"),
												(e.round = Ht);
										},
										function (e) {
											M.DEBUG &&
										...
										function (e) {
											...
											switch (
												...
												case 1:
													return void (e.inhibitGridFit =
														!!r);
												case 2:
													return void (e.ignoreCvt =
														!!r);
												default:
													throw new Error(
								...
								(Mr.prototype.hasChar = function (e) {
									return (
										null !==
										this.encoding.charToGlyphIndex(e)
									);
								}),
									(Mr.prototype.charToGlyphIndex = function (
										e
									) {
									...
									(Mr.prototype.stringToGlyphs = function (
										e,
										t
									) {
									...
									(Mr.prototype.nameToGlyphIndex = function (
										e
									) {
									...
									(Mr.prototype.glyphIndexToName = function (
										e
									) {
									...
									(Mr.prototype.getKerningValue = function (
										e,
										t
									) {
										(e = e.index || e), (t = t.index || t);
										var r =
											this.position.defaultKerningTables;
										return r
									...
									(Mr.prototype.forEachGlyph = function (
										e,
										t,
										r,
										i,
										...
										if (n.kerning) {
											...
											a = this.position.getKerningTables(
												l,
												n.language
											);
										}
									...
									(Mr.prototype.getPaths = function (
										e,
										t,
										r,
										i,
									...
									(Mr.prototype.getAdvanceWidth = function (
										e,
										t,
										r
									) {
									...
									(Mr.prototype.drawPoints = function (
										n,
										e,
										t,
										r,
									...
									(Mr.prototype.drawMetrics = function (
										n,
										e,
										t,
										r,
									...
									(Mr.prototype.getEnglishName = function (
										e
									) {
										var t = this.names[e];
										if (t) return t.en;
													...
													oe.pointer(
														oe.list(function () {
															return {
																secondGlyph:
																	this.parseUShort(),
																value1: this.parseValueRecord(
																	i
																),
																value2: this.parseValueRecord(
																	n
																),
															};
														})
								...
								function Gr(e) {
									...
									for (var _ = 0; _ < i; _ += 1) {
										...
										switch (x.tag) {
											...
											case "head":
												(w = Fr(v, x)),
													(m.tables.head = Ne.parse(
														w.data,
														w.offset
													)),
													(m.unitsPerEm =
														m.tables.head.unitsPerEm),
													(t =
														m.tables.head
															.indexToLocFormat);
												break;
											case "hhea":
												(w = Fr(v, x)),
													(m.tables.hhea = Ve.parse(
														w.data,
														w.offset
													)),
													(m.ascender =
														m.tables.hhea.ascender),
													(m.descender =
														m.tables.hhea.descender),
													(m.numberOfHMetrics =
														m.tables.hhea.numberOfHMetrics);
												break;
											case "hmtx":
												l = x;
												break;
											...
											case "maxp":
												(w = Fr(v, x)),
													(m.tables.maxp = je.parse(
														w.data,
														w.offset
													)),
													(m.numGlyphs =
														m.tables.maxp.numGlyphs);
												break;
											case "name":
												p = x;
												break;
													...
													e.cffEncoding
														? e.isCIDFont
															? (t.name =
																	"gid" + s)
															: (t.name =
																	e.cffEncoding.charset[
																		s
																	])
														: e.glyphNames.names &&
														  (t.name =
																e.glyphNames.glyphIndexToName(
																	s
																));
										})(m),
										u)
				...
				function (e, t, r) {
					...
					e("./p5.Color"),
						...
						(c.prototype.hue = function (e) {
							return (
								c._validateParameters("hue", arguments),
								this.color(e)._getHue()
							);
						}),
						(c.prototype.lerpColor = function (e, t, r) {
							...
							if (l === p.RGB)
								...
								if (l !== p.HSL)
									throw new Error(
										l + "cannot be used for interpolation."
									);
								e._getLightness(),
									t._getLightness(),
									(s = e.hsla),
						...
						(c.prototype.red = function (e) {
							return (
								c._validateParameters("red", arguments),
								this.color(e)._getRed()
							);
						}),
				...
				function (e, t, r) {
					...
					(c.Color = function (e, t) {
						if (
							...
							throw new Error(
								this.mode + " is an invalid colorMode."
							);
						return (
						...
						(c.Color.prototype.toString = function (e) {
							this.hsba ||
								(this.hsba = d._rgbaToHSBA(this._array)),
								this.hsla ||
									(this.hsla = d._rgbaToHSLA(this._array));
							var t = this.levels,
								r = this._array,
								i = r[3];
							switch (e) {
						...
						(c.Color.prototype._storeModeAndMaxes = function (
							e,
							t
						) {
						...
						(c.Color.prototype._getHue = function () {
							return this.mode === p.HSB
								? (this.hsba ||
										(this.hsba = d._rgbaToHSBA(
											this._array
										)),
								  this.hsba[0] * this.maxes[p.HSB][0])
								: (this.hsla ||
										(this.hsla = d._rgbaToHSLA(
											this._array
										)),
								  this.hsla[0] * this.maxes[p.HSL][0]);
						}),
					...
					(c.Color._parseInputs = function (e, t, r, i) {
						...
						if (1 === o && "string" == typeof e) {
							...
							if (f[u])
								return c.Color._parseInputs.call(this, f[u]);
							if (m.HEX3.test(u))
								return (
									((h = m.HEX3.exec(u)
										.slice(1)
				...
				function (e, t, r) {
					...
					e("./p5.Color"),
						(a.prototype.background = function () {
							return (
								arguments[0] instanceof a.Image
									...
									: this._renderer.background.apply(
											this._renderer,
											arguments
									  ),
								this
						...
						(a.prototype.noFill = function () {
							return (
								this._renderer._setProperty("_doFill", !1), this
							);
						}),
						(a.prototype.noStroke = function () {
							return (
								this._renderer._setProperty("_doStroke", !1),
								this
							);
						}),
				...
				function (e, t, r) {
					...
					(i.prototype.print = function () {
								...
								t &&
									...
									(i =
										...
										"https://" === e.substring(0, 8)
											? "url(" + e + ") " + o + ", auto"
											: /\.(cur|jpg|jpeg|gif|png|CUR|JPG|JPEG|GIF|PNG)$/.test(
													e
											  )
											? "url(" + e + ") " + o + ", auto"
											: e);
						...
						(i.prototype.fullscreen = function (e) {
							if (
								(i._validateParameters("fullscreen", arguments),
								void 0 === e)
							)
								return (
				...
				function (e, t, r) {
					...
					var i = e("../core/main"),
						n = function () {
							window.mocha ||
								(((window.setup &&
									"function" == typeof window.setup) ||
									(window.draw &&
										"function" == typeof window.draw)) &&
									!i.instance &&
									new i());
						};
					"complete" === document.readyState
			...
			23: [
				function (e, t, r) {
					...
					var i = e("./constants"),
						m = function (e, t, r) {
							...
							window.DeviceOrientationEvent &&
									...
									if (e) {
										...
										for (var i in r) {
											...
											(n !== m.prototype && n !== m) ||
												...
												(n = this)),
												(this._registeredPreloadMethods[
													i
												] = n[i]),
												(n[i] = this._wrapPreload(
													n,
													i
												));
										}
									...
									if (
										...
										for (
											...
											for (var n in (i.elt.parentNode &&
												i.elt.parentNode.removeChild(
													i.elt
												),
											i._events))
												i.elt.removeEventListener(
													n,
													i._events[n]
												);
										}
										var o = this;
										this._registeredMethods.remove.forEach(
											function (e) {
												void 0 !== e && e.call(o);
											}
										);
								...
								this._registeredMethods.init.forEach(function (
									e
								) {
								...
								m.prototype))
									if ("function" == typeof m.prototype[s]) {
										...
										this._events.hasOwnProperty(h) ||
											(Math.hasOwnProperty(s) &&
											Math[s] === m.prototype[s]
												? a(s, m.prototype[s])
												: a(
														s,
														m.prototype[s].bind(
					...
					(m.prototype._preloadMethods = {
						...
						(m.prototype._createFriendlyGlobalFunctionBinder =
							function (e) {
				...
				function (e, t, r) {
					...
					(o.Element = function (e, t) {
						...
						(o.Element.prototype.doubleClicked = function (e) {
							return (
								o.Element._adjustListener("dblclick", e, this),
								this
							);
						}),
						(o.Element.prototype.mouseWheel = function (e) {
							return (
								o.Element._adjustListener("wheel", e, this),
								this
							);
						}),
						(o.Element.prototype.mouseReleased = function (e) {
							return (
								o.Element._adjustListener("mouseup", e, this),
								this
							);
						}),
						(o.Element.prototype.mouseClicked = function (e) {
							return (
								o.Element._adjustListener("click", e, this),
								this
							);
						}),
						(o.Element.prototype.mouseMoved = function (e) {
							return (
								o.Element._adjustListener("mousemove", e, this),
								this
							);
						}),
						(o.Element.prototype.mouseOver = function (e) {
							return (
								o.Element._adjustListener("mouseover", e, this),
								this
							);
						}),
						(o.Element.prototype.mouseOut = function (e) {
							return (
								o.Element._adjustListener("mouseout", e, this),
								this
							);
						}),
						...
						(o.Element.prototype.touchMoved = function (e) {
							return (
								o.Element._adjustListener("touchmove", e, this),
								this
							);
						}),
						(o.Element.prototype.touchEnded = function (e) {
							return (
								o.Element._adjustListener("touchend", e, this),
								this
							);
						}),
						(o.Element.prototype.dragOver = function (e) {
							return (
								o.Element._adjustListener("dragover", e, this),
								this
							);
						}),
						(o.Element.prototype.dragLeave = function (e) {
							return (
								o.Element._adjustListener("dragleave", e, this),
								this
							);
						}),
						(o.Element.prototype.drop = function (n, e) {
							if (
								...
								void 0 !== e &&
									o.Element._attachListener("drop", e, this),
						...
						(o.Element._attachListener = function (e, t, r) {
							...
							var i = t.bind(r);
							r.elt.addEventListener(e, i, !1),
								(r._events[e] = i);
						}),
						(o.Element._detachListener = function (e, t) {
							var r = t._events[e];
							t.elt.removeEventListener(e, r, !1),
								(t._events[e] = null);
						}),
			...
			25: [
				function (e, t, r) {
					...
					(s.Graphics = function (e, t, r, i) {
						...
						return (
							s.prototype._initializeInstanceVariables.apply(
								this
							),
							(this.width = e),
							(this.height = t),
							...
							n === h.WEBGL
								? (this._renderer = new s.RendererGL(
										this.canvas,
										this,
										!1
								  ))
								: (this._renderer = new s.Renderer2D(
										this.canvas,
										this,
										!1
								  )),
						...
						(s.Graphics.prototype = Object.create(
							s.Element.prototype
						)),
						(s.Graphics.prototype.remove = function () {
							...
							for (var t in (-1 !== e &&
								this._pInst._elements.splice(e, 1),
							this._events))
								this.elt.removeEventListener(
									t,
									this._events[t]
								);
						}),
			...
			26: [
				function (e, t, r) {
					...
					(i.Renderer = function (e, t, r) {
						...
						(i.Renderer.prototype = Object.create(
							i.Element.prototype
						)),
						...
						(i.Renderer.prototype.resize = function (e, t) {
							(this.width = e),
								(this.height = t),
								(this.elt.width =
									e * this._pInst._pixelDensity),
								(this.elt.height =
									t * this._pInst._pixelDensity),
						...
						(i.Renderer.prototype.textLeading = function (e) {
							return "number" == typeof e
								? (this._setProperty("_textLeading", e),
								  this._pInst)
								: this._textLeading;
						}),
						...
						(i.Renderer.prototype.textAlign = function (e, t) {
							return void 0 !== e
								? (this._setProperty("_textAlign", e),
								  void 0 !== t &&
										this._setProperty("_textBaseline", t),
								  this._applyTextProperties())
								: {
			...
			27: [
				function (e, t, r) {
					...
					(m.Renderer2D = function (e, t, r) {
						...
						(m.Renderer2D.prototype = Object.create(
							m.Renderer.prototype
						)),
						(m.Renderer2D.prototype._applyDefaults = function () {
							(this._cachedFillStyle = this._cachedStrokeStyle =
								void 0),
							...
							try {
								this._tint &&
									(m.MediaElement &&
										...
										e.loadPixels(),
									e.canvas &&
										(l = this._getTintedImageCanvas(e))),
									l || (l = e.canvas || e.elt);
								var u = 1;
								e.width &&
									0 < e.width &&
						...
						(m.Renderer2D.prototype._getTintedImageCanvas =
							function (e) {
						...
						(m.Renderer2D.prototype.loadPixels = function () {
							...
							if (e._pixelsDirty) {
								...
								var t = e._pixelDensity,
									r = this.width * t,
									i = this.height * t,
									n = this.drawingContext.getImageData(
										0,
										0,
										r,
										i
						...
						(m.Renderer2D.prototype.updatePixels = function (
							e,
							t,
							r,
							i
						...
						(m.Renderer2D.prototype._acuteArcToBezier = function (
							e,
							t
						) {
							var r = t / 2,
						...
						(m.Renderer2D.prototype.arc = function (
							r,
							i,
							e,
							t,
						...
						(m.Renderer2D.prototype.quad = function (
							e,
							t,
							r,
							i,
						...
						(m.Renderer2D.prototype.endShape = function (
							e,
							t,
							r,
							i,
							...
							if (!r || (a !== f.POLYGON && null !== a))
								if (!i || (a !== f.POLYGON && null !== a))
									...
									for (
										this.drawingContext.beginPath(), h = 0;
										h < c;
										h++
									)
										t[h].isVert
						...
						(m.Renderer2D.prototype.noSmooth = function () {
							return (
								"imageSmoothingEnabled" in
									this.drawingContext &&
									(this.drawingContext.imageSmoothingEnabled =
										!1),
								this
							);
						}),
						...
						(m.Renderer2D.prototype.bezier = function (
							e,
							t,
							r,
							i,
						...
						(m.Renderer2D.prototype.curve = function (
							e,
							t,
							r,
							i,
						...
						(m.Renderer2D.prototype._doFillStrokeClose = function (
							e
						) {
						...
						(m.Renderer2D.prototype.applyMatrix = function (
							e,
							t,
							r,
							i,
						...
						(m.Renderer2D.prototype.text = function (
							e,
							t,
							r,
							i,
							...
							var a = m.Renderer.prototype.text.apply(
								this,
								arguments
							);
							return (
						...
						(m.Renderer2D.prototype._renderText = function (
							e,
							t,
							r,
							i,
							...
							if (!(n <= i))
								return (
									e.push(),
									this._isOpenType()
										? this._textFont._renderPath(t, r, i, {
												renderer: this,
										  })
										: (this._doStroke &&
												this._strokeSet &&
						...
						(m.Renderer2D.prototype._applyTextProperties =
							function () {
								var e,
									t = this._pInst;
								return (
				...
				function (e, t, r) {
					...
					(s.prototype.createCanvas = function (e, t, r) {
						...
						if (n === h.WEBGL) {
							...
							for (
								var a = 0;
								document.getElementById("defaultCanvas" + a);
				...
				function (e, t, r) {
					...
					e("../error_helpers"),
						(l.prototype.arc = function (e, t, r, i, n, o, a, s) {
							if (
								...
								!this._renderer._doStroke &&
									!this._renderer._doFill)
							)
								return this;
							for (
								n = this._toRadians(n), o = this._toRadians(o);
								n < 0;
						...
						(l.prototype.ellipse = function (e, t, r, i, n) {
							...
							return (
								this._renderer.ellipse([o.x, o.y, o.w, o.h, n]),
								this
							);
						}),
					...
					(i.prototype.beginContour = function () {
						...
						(i.prototype.beginShape = function (e) {
							return (
								...
								this._renderer.isP3D
									? this._renderer.beginShape.apply(
											this._renderer,
											arguments
									  )
									: ((o =
						...
						(i.prototype.bezierVertex = function () {
							if (
								...
								this._renderer.bezierVertex.apply(
									this._renderer,
									arguments
								);
							else if (0 === a.length)
						...
						(i.prototype.curveVertex = function () {
							return (
								...
								this._renderer.isP3D
									? this._renderer.curveVertex.apply(
											this._renderer,
											arguments
									  )
									: ((l = !0),
						...
						(i.prototype.quadraticVertex = function () {
							if (
								...
								this._renderer.quadraticVertex.apply(
									this._renderer,
									arguments
								);
							else {
				...
				function (e, t, r) {
					...
					(i.prototype.noLoop = function () {
						...
						(i.prototype.pop = function () {
							...
							e
								? (this._renderer.pop(e.renderer),
								  Object.assign(this, e.props))
								: console.warn(
			...
			35: [
				function (e, t, r) {
					...
					(o.prototype.applyMatrix = function (e, t, r, i, n, o) {
						return (
							this._renderer.applyMatrix(e, t, r, i, n, o), this
						);
					}),
					...
					(n.prototype.createStringDict = function (e, t) {
						...
						(n.TypedDict.prototype.get = function (e) {
							if (this.data.hasOwnProperty(e))
								return this.data[e];
							console.log(
								e + " does not exist in this Dictionary"
							);
						}),
						...
						(n.StringDict.prototype = Object.create(
							n.TypedDict.prototype
						)),
						...
						(n.NumberDict.prototype = Object.create(
							n.TypedDict.prototype
						)),
			...
			37: [
				function (e, t, r) {
					...
					(i.prototype.setMoveThreshold = function (e) {
						i._validateParameters("setMoveThreshold", arguments),
							(_ = e);
					}),
						...
						(i.prototype._handleMotion = function () {
							...
							"function" == typeof e &&
								(Math.abs(
									...
									Math.abs(
										this.accelerationZ - this.pAccelerationZ
									) > _) &&
								e();
				...
				function (e, t, r) {
					...
					(i.prototype.isKeyPressed = !1),
						...
						(i.prototype.keyIsDown = function (e) {
							return (
								i._validateParameters("keyIsDown", arguments),
								n[e]
							);
						}),
						(t.exports = i);
							...
							(function (e) {
								...
								if (R !== (t = t < 1 ? 1 : t < 248 ? t : 248)) {
									(L = (1 + (R = t)) << 1),
										...
										(k = new Array(L));
									for (var r = 0; r < L; r++)
										k[r] = new Int32Array(256);
									for (
										var i, n, o, a, s = 1, h = t - 1;
										s < t;
										s++
									) {
										(P[t + s] = P[h] = n = h * h),
			...
			42: [
				function (e, t, r) {
					...
					(c.prototype.createImage = function (e, t) {
						return (
							c._validateParameters("createImage", arguments),
							new c.Image(e, t)
						);
					}),
						(c.prototype.saveCanvas = function () {
							...
							switch (
								...
								(r =
									r ||
									c.prototype._checkFileExtension(t, r)[1] ||
									"png"))
							) {
								default:
									i = "image/png";
					...
					e("../core/error_helpers"),
						(x.prototype.loadImage = function (e, t, r) {
							...
							return (
								...
								0 !== e.indexOf("data:image/") &&
									(i.crossOrigin = "Anonymous"),
								(i.src = e),
								n
							);
						}),
						(x.prototype.image = function (
							e,
							t,
							r,
							i,
						...
						(x.prototype._getTintedImageCanvas = function (e) {
							...
							for (
								...
								(o[a] = (s * this._renderer._tint[0]) / 255),
									(o[a + 1] =
										(h * this._renderer._tint[1]) / 255),
									(o[a + 2] =
										(l * this._renderer._tint[2]) / 255),
									(o[a + 3] =
										(u * this._renderer._tint[3]) / 255);
							}
							return i.putImageData(n, 0, 0), r;
						}),
			...
			44: [
				function (e, t, r) {
					...
					(l.Image = function (e, t) {
						...
						(l.Image.prototype.updatePixels = function (
							e,
							t,
							r,
							i
						) {
							l.Renderer2D.prototype.updatePixels.call(
								this,
								e,
								t,
								r,
						...
						(l.Image.prototype.mask = function (e) {
							...
							var t =
									this.drawingContext
										.globalCompositeOperation,
								r = 1;
							e instanceof l.Renderer &&
								(r = e._pInst._pixelDensity);
							var i = [
								e,
								0,
								0,
						...
						(l.Image.prototype.blend = function () {
							l.prototype.blend.apply(this, arguments),
								this.setModified(!0);
						}),
					...
					e("../color/p5.Color"),
						...
						(n.prototype.blend = function () {
							n._validateParameters("blend", arguments),
								this._renderer
									? this._renderer.blend.apply(
											this._renderer,
											arguments
									  )
									: n.Renderer2D.prototype.blend.apply(
											this,
											arguments
									  );
						}),
						(n.prototype.copy = function () {
							n._validateParameters("copy", arguments),
								n.Renderer2D.prototype.copy.apply(
									this._renderer,
									arguments
								);
						}),
								...
								t >= this.height
									...
									: ((e = Math.floor(e)),
									  ...
									  this instanceof n.Image
											? n.Renderer2D.prototype.get.call(
													this,
													e,
													t,
													r,
				...
				function (s, e, t) {
					...
					s("../core/error_helpers"),
						(v.prototype.loadJSON = function () {
							...
							return (
								this.httpDo(
									...
									function (e) {
										if (
											(v._friendlyFileLoadError(5, i), !t)
										)
											throw e;
										t(e);
									}
						...
						(v.prototype.loadStrings = function () {
							...
							return (
								v.prototype.httpDo.call(
									...
									function (e) {
										if (
											(v._friendlyFileLoadError(3, e), !t)
										)
											throw e;
										t(e);
									}
								...
								this.httpDo(
									...
									function (e) {
										...
										if (c) f.columns = n.shift();
											...
											for (d = 0; d < n[0].length; d++)
												f.columns[d] = "null";
										for (d = 0; d < n.length; d++)
											(1 !== n[d].length ||
												("undefined" !== n[d][0] &&
													"" !== n[d][0])) &&
												(((r = new v.TableRow()).arr =
													n[d]),
						...
						(v.prototype.loadXML = function () {
							...
							return (
								this.httpDo(
									...
									function (e) {
										if (
											(v._friendlyFileLoadError(1, e), !t)
										)
											throw e;
										t(e);
									}
						...
						(v.prototype.loadBytes = function (t, r, i) {
							...
							return (
								this.httpDo(
									...
									function (e) {
										if (
											(v._friendlyFileLoadError(6, t), !i)
										)
											throw e;
										i(e);
									}
						...
						(v.prototype.httpGet = function () {
							...
							return (
								e.splice(1, 0, "GET"),
								v.prototype.httpDo.apply(this, e)
							);
						}),
						...
						(v.prototype.save = function (e, t, r) {
							...
							if (0 !== i.length)
								if (
									i[0] instanceof v.Renderer ||
									i[0] instanceof v.Graphics
								)
									v.prototype.saveCanvas(
										i[0].elt,
										i[1],
										i[2]
									);
									...
									switch (h(i[1], i[2])[1]) {
										case "json":
											return void v.prototype.saveJSON(
												i[0],
												i[1],
												i[2]
											);
										case "txt":
											return void v.prototype.saveStrings(
												i[0],
												i[1],
												i[2]
											);
										default:
											i[0] instanceof Array
												? v.prototype.saveStrings(
														i[0],
														i[1],
														i[2]
												  )
												: i[0] instanceof v.Table
												? v.prototype.saveTable(
														i[0],
														i[1],
														i[2]
												  )
				...
				function (e, t, r) {
					...
					(i.Table = function (e) {
						...
						(i.Table.prototype.matchRows = function (e, t) {
							...
							if ("number" == typeof t)
								for (var i = 0; i < this.rows.length; i++)
									this.rows[i].arr[t].match(e) &&
										r.push(this.rows[i]);
							else
								for (var n = 0; n < this.rows.length; n++)
									this.rows[n].obj[t].match(e) &&
										r.push(this.rows[n]);
							return r;
						}),
							...
							if (void 0 === t)
								for (var o = 0; o < this.columns.length; o++)
									for (var a = 0; a < this.rows.length; a++) {
										...
										(s = s.replace(n, "")),
											(this.rows[a].arr[o] = s),
											(this.rows[a].obj[this.columns[o]] =
												s);
									}
							...
							if (void 0 === e)
								for (var r = 0; r < this.columns.length; r++)
									for (var i = 0; i < this.rows.length; i++) {
										...
										(n = n.replace(t, "")),
											(this.rows[i].arr[r] = n),
											(this.rows[i].obj[this.columns[r]] =
												n);
									}
							else if ("string" == typeof e)
						...
						(i.Table.prototype.removeColumn = function (e) {
							...
							var i = this.columns.splice(
								r + 1,
								this.columns.length
							);
							this.columns.pop(),
								(this.columns = this.columns.concat(i));
							for (var n = 0; n < this.rows.length; n++) {
							...
							for (
								...
								if (
									...
									if (!(0 <= this.columns.indexOf(e)))
										throw new Error(
											'This table has no column named "' +
												e +
												'"'
										);
									r[t[e]] = t;
				...
				function (e, t, r) {
					...
					(i.XML = function (e) {
						if (e) this.DOM = e;
							...
							var t = document.implementation.createDocument(
								null,
								"doc"
							);
						...
						(i.XML.prototype.getChildren = function (e) {
							return n(
								e
									? this.DOM.getElementsByTagName(e)
									: this.DOM.children
							);
						}),
						(i.XML.prototype.getChild = function (e) {
							if ("string" != typeof e)
								return new i.XML(this.DOM.children[e]);
						...
						(i.XML.prototype.removeChild = function (e) {
							...
							-1 !== t &&
								this.DOM.removeChild(this.DOM.children[t]);
						}),
						...
						(i.XML.prototype.getContent = function (e) {
							return (
								this.DOM.textContent.replace(/\s\s+/g, ",") ||
								e ||
								null
							);
						}),
			...
			50: [
				function (e, t, r) {
					...
					function i(e, t, r) {
						...
						for (
							var i = arguments.length, n = [], o = 0, a = 0;
							a < i;
							a++
						) {
							var s = arguments[a];
					...
					(s.prototype.abs = Math.abs),
						...
						(s.prototype.lerp = function (e, t, r) {
							return (
								s._validateParameters("lerp", arguments),
								r * (t - e) + e
							);
						}),
						...
						(s.prototype.mag = function (e, t) {
							return (
								s._validateParameters("mag", arguments), i(e, t)
							);
						}),
				...
				function (e, t, r) {
					...
					(s.Vector = function () {
						...
						(s.Vector.prototype.limit = function (e) {
							var t = this.magSq();
							return (
								e * e < t && this.div(Math.sqrt(t)).mult(e),
								this
							);
						}),
						...
						(s.Vector.lerp = function (e, t, r, i) {
							return (
								i ? i.set(e) : (i = e.copy()), i.lerp(t, r), i
							);
						}),
				...
				function (e, t, r) {
					...
					(a.prototype.randomSeed = function (e) {
						...
						(a.prototype.random = function (e, t) {
							var r;
							if (
								((r = s ? u.rand() : Math.random()),
								void 0 === e)
							)
								return r;
							if (void 0 === t)
								return e instanceof Array
									? e[Math.floor(r * e.length)]
									: r * e;
							if (t < e) {
								var i = e;
								(e = t), (t = i);
				...
				function (e, t, r) {
					...
					(i.prototype._angleMode = n.RADIANS),
						...
						(i.prototype.angleMode = function (e) {
							(e !== n.DEGREES && e !== n.RADIANS) ||
								(this._angleMode = e);
						}),
						(i.prototype._toRadians = function (e) {
							return this._angleMode === n.DEGREES
								? e * n.DEG_TO_RAD
								: e;
						}),
						(i.prototype._toDegrees = function (e) {
							return this._angleMode === n.RADIANS
								? e * n.RAD_TO_DEG
								: e;
						}),
				...
				function (e, t, r) {
					...
					(i.prototype.textAlign = function (e, t) {
						return (
							...
							this._renderer.textAlign.apply(
								this._renderer,
								arguments
							)
						);
						...
						(i.prototype.textLeading = function (e) {
							return (
								...
								this._renderer.textLeading.apply(
									this._renderer,
									arguments
								)
							);
						...
						(i.prototype.textStyle = function (e) {
							return (
								...
								this._renderer.textStyle.apply(
									this._renderer,
									arguments
								)
							);
						...
						(i.prototype.textWidth = function (e) {
							return (
								...
								0 === e.length
									? 0
									: this._renderer.textWidth.apply(
											this._renderer,
											arguments
									  )
							);
				...
				function (e, t, r) {
					...
					e("../core/error_helpers"),
						...
						(p.prototype.textFont = function (e, t) {
							if (
								(p._validateParameters("textFont", arguments),
								arguments.length)
							) {
								if (!e)
									throw new Error(
										"null font passed to textFont"
									);
								return (
			...
			58: [
				function (e, t, r) {
								...
								u = (e = (function (e, t) {
									...
									for (var f = 0; f < o; f++) {
										...
										(r.x = m[g - 2]),
											(r.y = m[g - 1]),
											(r.bx =
												parseFloat(m[g - 4]) || r.x),
											(r.by =
												parseFloat(m[g - 3]) || r.y),
											(i.bx =
												s &&
												(parseFloat(v[y - 4]) || i.x)),
											(i.by =
												s &&
												(parseFloat(v[y - 3]) || i.y)),
											(i.x = s && v[y - 2]),
											(i.y = s && v[y - 1]);
									}
									return s ? [a, s] : a;
					...
					function b(e) {
						...
						for (
							...
							if (
								(t.push((h = [])),
								(l = e[c])[0] !==
									String.prototype.toUpperCase.call(l[0]))
							)
								switch (
									((h[0] = String.prototype.toUpperCase.call(
										l[0]
									)),
									h[0])
								) {
					...
					(i.Font = function (e) {
						...
						(i.Font.prototype.textBounds = function (
							e,
							t,
							r,
							i,
							...
							var o,
								a =
									(n && n.renderer && n.renderer._pInst) ||
									this.parent,
						...
						(i.Font.prototype.textToPoints = function (
							e,
							t,
							r,
							i,
						...
						(i.Font.prototype._getPath = function (e, t, r, i) {
							var n = (
									(i && i.renderer && i.renderer._pInst) ||
									this.parent
								)._renderer,
						...
						(i.Font.prototype._renderPath = function (e, t, r, i) {
							...
							return (
								...
								o._doFill &&
									(o._fillSet ||
										o._setFill(m._DEFAULT_TEXT_FILL),
									a.fill()),
								this
							);
						}),
						...
						(i.Font.prototype._handleAlignment = function (
							e,
							t,
							r,
							i,
							...
							var o = e._textSize;
							switch (
								(void 0 === n && (n = this._textWidth(t, o)),
								e._textAlign)
							) {
								case m.CENTER:
									r -= n / 2;
				...
				function (e, t, r) {
					...
					e("../core/error_helpers"),
						(a.prototype.join = function (e, t) {
							return (
								a._validateParameters("join", arguments),
								e.join(t)
							);
						}),
						(a.prototype.match = function (e, t) {
							return (
								a._validateParameters("match", arguments),
								e.match(t)
							);
						}),
						...
						(a.prototype.split = function (e, t) {
							return (
								a._validateParameters("split", arguments),
								e.split(t)
							);
						}),
			...
			63: [
				function (e, t, r) {
					...
					(x.prototype.plane = function (e, t, r, i) {
						...
						return (
							this._renderer.drawBuffersScaled(n, e, t, 1), this
						);
					}),
						(x.prototype.box = function (e, t, r, i, n) {
							...
							return (
								this._renderer.drawBuffersScaled(a, e, t, r),
								this
							);
						}),
					...
					(x.prototype.cylinder = function (e, t, r, i, n, o) {
						...
						return (
							this._renderer.drawBuffersScaled(a, e, t, e), this
						);
					}),
						(x.prototype.cone = function (e, t, r, i, n) {
							...
							return (
								this._renderer.drawBuffersScaled(o, e, t, e),
								this
							);
						}),
						(x.prototype.ellipsoid = function (e, t, r, i, n) {
							...
							return (
								this._renderer.drawBuffersScaled(o, e, t, r),
								this
							);
						}),
						(x.prototype.torus = function (e, t, r, i) {
							...
							return (
								this._renderer.drawBuffersScaled(n, e, e, e),
								this
							);
						}),
						...
						(x.RendererGL.prototype.arc = function (e) {
							...
							if (
								...
								var c = new x.Geometry(u, 1, function () {
									if (
										((this.strokeIndices = []),
										s.toFixed(10) !== h.toFixed(10))
									) {
										(l !== d.PIE && void 0 !== l) ||
											(this.vertices.push(
												new x.Vector(0.5, 0.5, 0)
											),
						...
						(x.RendererGL.prototype.quad = function (
							e,
							t,
							r,
							i,
							...
							if (
								...
								for (
									...
									if (
										...
										(e =
											parseFloat(c.toFixed(6)) +
											parseFloat(u.toFixed(6))),
											++p,
											(this._lookUpTableBezier[p] =
												this._bezierCoefficients(e));
										break;
							...
							if (6 === h) {
								for (
									...
									(t =
										...
										(r =
											a[0] *
												this._lookUpTableBezier[n][0] +
											a[1] *
												this._lookUpTableBezier[n][1] +
											a[2] *
												this._lookUpTableBezier[n][2] +
											a[3] *
												this._lookUpTableBezier[n][3]),
										this.vertex(t, r);
								(this.immediateMode._bezierVertex[0] =
									arguments[4]),
									(this.immediateMode._bezierVertex[1] =
						...
						(x.RendererGL.prototype.quadraticVertex = function () {
							if (
								0 === this.immediateMode._quadraticVertex.length
							)
								throw Error(
									"vertex() must be used once before calling quadraticVertex()"
								);
							...
							if (
								...
								(this._lookUpTableQuadratic = []),
									(this._lutQuadraticDetail =
										this._pInst._curveDetail);
								for (
									var l = 1 / this._lutQuadraticDetail,
										u = 0,
										c = 1,
										p = 0;
									u < 1;
							...
							if (4 === h) {
								for (
									...
									(t =
										o[0] *
											this._lookUpTableQuadratic[n][0] +
										o[1] *
											this._lookUpTableQuadratic[n][1] +
										o[2] *
											this._lookUpTableQuadratic[n][2]),
										(r =
											a[0] *
												this._lookUpTableQuadratic[
													n
						...
						(x.RendererGL.prototype.curveVertex = function () {
							...
							if (2 === h) {
								if (
									...
									8 ===
										this.immediateMode._curveVertex.length)
								) {
									for (
										this.isCurve = !0,
				...
				function (e, t, r) {
					...
					(c.prototype.orbitControl = function (e, t) {
						if (
							...
							if (
								...
								if (this.mouseButton === this.LEFT) {
									var n =
											(-e *
												(this.mouseX - this.pmouseX)) /
											i,
										o =
											(t * (this.mouseY - this.pmouseY)) /
											i;
									this._renderer._curCamera._orbit(n, o, 0);
								} else if (this.mouseButton === this.RIGHT) {
									var a = r._getLocalAxes(),
										s = Math.sqrt(
											a.x[0] * a.x[0] + a.x[2] * a.x[2]
										);
									0 !== s && ((a.x[0] /= s), (a.x[2] /= s));
									var h = Math.sqrt(
										a.y[0] * a.y[0] + a.y[2] * a.y[2]
									);
									0 !== h && ((a.y[0] /= h), (a.y[2] /= h));
									var l =
											-1 *
						...
						(c.prototype.debugMode = function () {
							...
							for (
								var e = this._registeredMethods.post.length - 1;
								0 <= e;
								e--
							)
								(this._registeredMethods.post[e].toString() !==
									this._grid().toString() &&
									this._registeredMethods.post[
										e
									].toString() !==
									...
									this.push(),
										this._renderer.uMVMatrix.set(
											...
											this._renderer._curCamera
												.cameraMatrix.mat4[9],
											this._renderer._curCamera
												.cameraMatrix.mat4[10],
											this._renderer._curCamera
												.cameraMatrix.mat4[11],
											this._renderer._curCamera
												.cameraMatrix.mat4[12],
											this._renderer._curCamera
												.cameraMatrix.mat4[13],
											this._renderer._curCamera
												.cameraMatrix.mat4[14],
											this._renderer._curCamera
												.cameraMatrix.mat4[15]
										),
										this.strokeWeight(2),
										this.stroke(255, 0, 0),
										this.beginShape(this.LINES),
				...
				function (e, t, r) {
					...
					(d.prototype.ambientLight = function (e, t, r, i) {
						...
						return (
							...
							o.setUniform(
								"uAmbientColor",
								this._renderer.ambientLightColors
							),
							o.setUniform(
								"uAmbientLightCount",
						...
						(d.prototype.directionalLight = function (
							e,
							t,
							r,
							i,
						...
						(d.prototype.pointLight = function (e, t, r, i, n, o) {
							...
							return (
								...
								this._renderer.pointLightPositions.push(
									s,
									h,
									l
								),
					...
					e("./p5.Texture"),
						...
						(a.prototype.normalMaterial = function () {
							return (
								...
								this._renderer.setFillShader(
									this._renderer._getNormalShader()
								),
						...
						(a.RendererGL.prototype._applyColorBlend = function (
							e
						) {
							var t = this.GL,
			...
			68: [
				function (e, t, r) {
					...
					(m.prototype.camera = function () {
						...
						(m.Camera.prototype.perspective = function (
							e,
							t,
							r,
							i
						...
						(m.Camera.prototype.ortho = function (
							e,
							t,
							r,
							i,
							...
							void 0 === e && (e = -this._renderer.width / 2),
								...
								void 0 === r &&
									(r = -this._renderer.height / 2),
								void 0 === i &&
									(i = +this._renderer.height / 2),
								void 0 === n && (n = 0),
								void 0 === o &&
									(o = Math.max(
						...
						(m.Camera.prototype._rotateView = function (
							e,
							t,
							r,
							i
						...
						(m.Camera.prototype.camera = function (
							e,
							t,
							r,
							i,
							...
							function () {
								(this.defaultCameraFOV = (60 / 180) * Math.PI),
									...
									(this.defaultCameraNear =
										0.1 * this.defaultEyeZ),
									(this.defaultCameraFar =
										10 * this.defaultEyeZ);
							}),
				...
				function (e, t, r) {
					...
					(u.Geometry = function (e, t, r) {
						...
						(u.Geometry.prototype._makeTriangleEdges = function () {
							if (
								((this.edges.length = 0),
								Array.isArray(this.strokeIndices))
							)
								for (
									var e = 0, t = this.strokeIndices.length;
									e < t;
									e++
								)
				...
				function (e, t, r) {
					...
					"undefined" != typeof Float32Array &&
						...
						(P.Matrix.prototype.determinant = function () {
							var e =
									this.mat4[0] * this.mat4[5] -
									this.mat4[1] * this.mat4[4],
								t =
									this.mat4[0] * this.mat4[6] -
									this.mat4[2] * this.mat4[4],
								r =
									this.mat4[0] * this.mat4[7] -
									this.mat4[3] * this.mat4[4],
								i =
									this.mat4[1] * this.mat4[6] -
									this.mat4[2] * this.mat4[5],
								n =
									this.mat4[1] * this.mat4[7] -
									this.mat4[3] * this.mat4[5],
								o =
									this.mat4[2] * this.mat4[7] -
									this.mat4[3] * this.mat4[6],
								a =
						...
						(P.Matrix.prototype.mult = function (e) {
							...
							return (
								(this.mat4[0] =
									r * t[0] + i * t[4] + n * t[8] + o * t[12]),
								(this.mat4[1] =
									r * t[1] + i * t[5] + n * t[9] + o * t[13]),
								(this.mat4[2] =
									r * t[2] +
									i * t[6] +
									n * t[10] +
						...
						(P.Matrix.prototype.perspective = function (
							e,
							t,
							r,
							i
						...
						(P.Matrix.prototype.ortho = function (
							e,
							t,
							r,
							i,
			...
			71: [
				function (e, t, r) {
					...
					(c.RendererGL.prototype.beginShape = function (e) {
						...
						(c.RendererGL.prototype.endShape = function (
							e,
							t,
							r,
							i,
						...
						(c.RendererGL.prototype._drawFillImmediateMode =
							function (e, t, r, i, n, o) {
								var a = this.GL;
								if (
						...
						(c.RendererGL.prototype._drawStrokeImmediateMode =
							function () {
								var e = this.GL;
								this.curStrokeShader.bindShader(),
									this.curStrokeShader.attributes.aPosition &&
										...
										this.curStrokeShader.enableAttrib(
											this.curStrokeShader.attributes
												.aPosition.location,
											3,
											e.FLOAT,
											!1,
			...
			72: [
				function (e, t, r) {
					...
					(i.RendererGL.prototype._initBufferDefaults = function (e) {
						...
						(i.RendererGL.prototype._freeBuffers = function (e) {
							...
							if (t) {
								...
								t.vertexBuffer &&
									...
									t.normalBuffer &&
										r.deleteBuffer(t.normalBuffer),
									t.lineNormalBuffer &&
										r.deleteBuffer(t.lineNormalBuffer),
									t.uvBuffer && r.deleteBuffer(t.uvBuffer),
									t.indexBuffer &&
										r.deleteBuffer(t.indexBuffer),
									t.lineVertexBuffer &&
										r.deleteBuffer(t.lineVertexBuffer);
							}
						}),
						(i.RendererGL.prototype.createBuffers = function (
							e,
							t
						) {
							var r = this.GL;
						...
						(i.RendererGL.prototype.drawBuffersScaled = function (
							e,
							t,
							r,
							i
						...
						(i.RendererGL.prototype._drawArrays = function (e, t) {
							return (
								this.GL.drawArrays(
									e,
									0,
									this.gHash[t].lineVertexCount
								),
								(this._pInst._pixelsDirty = !0),
								this
							);
						}),
						(i.RendererGL.prototype._drawElements = function (
							e,
							t
						) {
						...
						(i.RendererGL.prototype._drawPoints = function (e, t) {
							...
							this._bindBuffer(
								...
								this.curPointShader.enableAttrib(
									this.curPointShader.attributes.aPosition
										.location,
									3,
									r.FLOAT,
									!1,
			...
			73: [
				function (e, t, r) {
					...
					(f.RendererGL = function (e, t, r, i) {
						...
						(f.RendererGL.prototype = Object.create(
							f.Renderer.prototype
						)),
						(f.RendererGL.prototype._initContext = function () {
							try {
								...
								e.enable(e.DEPTH_TEST),
									...
									(this._viewport =
										this.drawingContext.getParameter(
						...
						(f.RendererGL.prototype._resetContext = function (
							e,
							t,
							r
						) {
						...
						(f.RendererGL.prototype.stroke = function (e, t, r, i) {
							...
							(this.curStrokeColor = n._array),
								...
								this.curPointShader.setUniform(
									"uMaterialColor",
									n._array
								);
						}),
						...
						(f.RendererGL.prototype.resize = function (e, t) {
							f.Renderer.prototype.resize.call(this, e, t),
								...
								(this._viewport = this.GL.getParameter(
									this.GL.VIEWPORT
								)),
						...
						(f.RendererGL.prototype.rotate = function (e, t) {
							return void 0 === t
								...
								: ((e = this._pInst._fromRadians(e)),
								  f.Matrix.prototype.rotate.apply(
										this.uMVMatrix,
										arguments
								  ),
								  this);
						...
						(f.RendererGL.prototype.resetMatrix = function () {
							return (
								(this.uMVMatrix = f.Matrix.identity(
									this._pInst
								)),
								this
							);
						...
						(f.RendererGL.prototype._useLightShader = function () {
							return (
								(this.curFillShader &&
									this.curFillShader.isLightShader()) ||
						...
						(f.RendererGL.prototype._useImmediateModeShader =
							function () {
								return (
									(this.curFillShader &&
										this.curFillShader !==
						...
						(f.RendererGL.prototype._getLightShader = function () {
							return (
								this._defaultLightShader ||
									(this.attributes.perPixelLighting
										? (this._defaultLightShader =
												new f.Shader(this, p, d))
										: (this._defaultLightShader =
												new f.Shader(this, u, c))),
								this._defaultLightShader
							);
						}),
						(f.RendererGL.prototype._getImmediateModeShader =
							function () {
								return (
									this._defaultImmediateModeShader ||
										(this._defaultImmediateModeShader =
											new f.Shader(this, n, a)),
									this._defaultImmediateModeShader
								);
							}),
						(f.RendererGL.prototype._getNormalShader = function () {
							return (
								this._defaultNormalShader ||
									(this._defaultNormalShader = new f.Shader(
										this,
										s,
										h
									)),
						...
						(f.RendererGL.prototype._getColorShader = function () {
							return (
								this._defaultColorShader ||
									(this._defaultColorShader = new f.Shader(
										this,
										s,
										l
									)),
						...
						(f.RendererGL.prototype._getPointShader = function () {
							return (
								this._defaultPointShader ||
									(this._defaultPointShader = new f.Shader(
										this,
										b,
										_
									)),
						...
						(f.RendererGL.prototype._getLineShader = function () {
							return (
								this._defaultLineShader ||
									(this._defaultLineShader = new f.Shader(
										this,
										g,
										y
									)),
						...
						(f.RendererGL.prototype._getFontShader = function () {
							return (
								this._defaultFontShader ||
									...
									(this._defaultFontShader = new f.Shader(
										this,
										m,
										v
									))),
						...
						(f.RendererGL.prototype._getEmptyTexture = function () {
							if (!this._emptyTexture) {
								...
								e.set(0, 0, 255),
									(this._emptyTexture = new f.Texture(
										this,
										e
									));
							}
						...
						(f.RendererGL.prototype._bindBuffer = function (
							e,
							t,
							r,
							i,
								...
								e.gluTessCallback(
									...
									function (e) {
										e !== i.primitiveType.GL_TRIANGLES &&
											console.log(
												"expected TRIANGLES but got type: " +
													e
											);
									}
								),
						...
						(f.RendererGL.prototype._bezierCoefficients = function (
							e
						) {
							var t = e * e,
								r = 1 - e,
						...
						(f.RendererGL.prototype._quadraticCoefficients =
							function (e) {
								var t = 1 - e;
								return [t * t, 2 * t * e, e * e];
							}),
						(f.RendererGL.prototype._bezierToCatmull = function (
							e
						) {
							return [
								e[1],
					...
					(i.Shader = function (e, t, r) {
						...
						(i.Shader.prototype.init = function () {
							if (0 === this._glProgram) {
								...
								if (
									((this._vertShader = e.createShader(
										e.VERTEX_SHADER
									)),
									e.shaderSource(
										this._vertShader,
								...
								if (
									((this._fragShader = e.createShader(
										e.FRAGMENT_SHADER
									)),
									e.shaderSource(
										this._fragShader,
						...
						(i.Shader.prototype._loadAttributes = function () {
							if (!this._loadedAttributes) {
								...
								for (
									...
									var i = e.getActiveAttrib(
											this._glProgram,
											r
										),
										n = i.name,
										o = e.getAttribLocation(
											this._glProgram,
											n
										),
										a = {};
						...
						(i.Shader.prototype._loadUniforms = function () {
							if (!this._loadedUniforms) {
								for (
									...
									var n = e.getActiveUniform(
											this._glProgram,
											i
										),
										o = {};
									(o.location = e.getUniformLocation(
										this._glProgram,
										n.name
									)),
										(o.size = n.size);
						...
						(i.Shader.prototype.unbindShader = function () {
							return (
								this._bound &&
									(this.unbindTextures(), (this._bound = !1)),
								this
							);
						}),
						(i.Shader.prototype.bindTextures = function () {
							for (
								...
								var r = this.samplers[t],
									i = r.texture;
								void 0 === i &&
									(i = this._renderer._getEmptyTexture()),
									e.activeTexture(
										e.TEXTURE0 + r.samplerIndex
									),
									i.bindTexture(),
									i.update(),
						...
						(i.Shader.prototype._setViewportUniform = function () {
							this.setUniform(
								"uViewport",
								this._renderer._viewport
							);
						}),
						(i.Shader.prototype.useProgram = function () {
							return (
								this._renderer.GL.useProgram(this._glProgram),
								this
							);
						}),
						(i.Shader.prototype.setUniform = function (e, t) {
							...
							if (r) {
								...
								switch ((this.useProgram(), r.type)) {
									...
									case n.SAMPLER_2D:
										n.activeTexture(
											n.TEXTURE0 + r.samplerIndex
										),
											(r.texture =
												this._renderer.getTexture(t)),
											n.uniform1i(
												r.location,
												r.samplerIndex
											);
			...
			75: [
				function (e, t, r) {
					...
					(n.Texture = function (e, t) {
						...
						(n.Texture.prototype._getTextureDataFromSource =
							function () {
								var e;
								return (
									this.isSrcP5Image
						...
						(n.Texture.prototype.setInterpolation = function (
							e,
							t
						) {
							var r = this._renderer.GL;
			...
			76: [
				function (e, t, r) {
					...
					e("./p5.Shader"),
						e("./p5.RendererGL"),
						(B.RendererGL.prototype._applyTextProperties =
							function () {}),
					...
					function i(e, t) {
						(this.width = e),
							...
							(this.findImage = function (e) {
								...
								if (i < e)
									throw new Error(
										"font is too complex to render in 3D"
									);
								for (
									var n = this.infos.length - 1;
									0 <= n;
									--n
								) {
									var o = this.infos[n];
							...
							(this.font = e),
								...
								(this.getGlyphInfo = function (e) {
									...
									function y(e, t, r, i) {
										(this.p0 = e),
											...
											(this.split = function (e) {
												...
												(this.c1 = B.Vector.lerp(
													this.c1,
													this.p1,
													e
												)),
													(this.c0 = B.Vector.lerp(
														r,
														this.c1,
														e
													));
									...
									for (
										var k = d.length,
											I =
												this.strokeImageInfos.findImage(
													k
												),
											D = I.index,
											A = 0;
					...
					B.RendererGL.prototype._renderText = function (
						e,
						t,
						r,
						i,
						...
						if (!(n <= i) && this._doFill) {
							if (!this._isOpenType())
								return (
									console.log(
										"WEBGL: only opentype fonts are supported"
									),
									e
								);
							e.push();
							...
							var u = this._textFont._handleAlignment(
									this,
									t,
									r,
									i
							...
							if (!m) {
								var v = (this._textGeom = new B.Geometry(
									1,
									1,
									function () {
										for (var e = 0; e <= 1; e++)
